...
class Body3dPoseEstimation:
    def __init__(self):
       #path_to_mmpose = "../../mmpose_ap"
        self.det_config = 'D:/Project/Internet/Django/key_video/Key_Video_Mocap/Key_Video_Mocap/ml/mlModel/mmpose_ap/mmpose/.mim/demo/mmdetection_cfg/faster_rcnn_r50_fpn_coco.py'
        ...
        self.pose_estimator_config = 'D:/Project/Internet/Django/key_video/Key_Video_Mocap/Key_Video_Mocap/ml/mlModel/mmpose_ap/mmpose/configs/body_2d_keypoint/topdown_heatmap/coco/td-hm_hrnet-w48_8xb32-210e_coco-256x192.py'

        self.pose_estimator_checkpoint = 'https://download.openmmlab.com/mmpose/top_down/hrnet/hrnet_w48_coco_256x192-b9e0b3ab_20200708.pth'

        self.pose_lifter_config = 'D:/Project/Internet/Django/key_video/Key_Video_Mocap/Key_Video_Mocap/ml/mlModel/mmpose_ap/mmpose/configs/body_3d_keypoint/pose_lift/h36m/pose-lift_videopose3d-243frm-supv-cpn-ft_8xb128-200e_h36m.py'
        self.pose_lifter_checkpoint = 'https://download.openmmlab.com/mmpose/body3d/videopose/videopose_h36m_243frames_fullconv_supervised_cpn_ft-88f5abbb_20210527.pth'
        self.device = "cuda:0"
    ...
    def prepare_model(self):
        detector = init_detector(
            self.det_config, self.det_checkpoint, device='cuda:0')
        ...
        pose_lifter.cfg.visualizer.radius = self.radius
        pose_lifter.cfg.visualizer.line_width = self.thickness
        ...
        return detector,pose_estimator,pose_lifter,visualizer

    def process_one_image(self, detector, frame, frame_idx, pose_estimator,
    ...
    def pose_inference(self,input):
        detector, pose_estimator, pose_lifter, visualizer = self.prepare_model()
        ...
        if input_type in ['webcam', 'video']:
            ...
            while video.isOpened():
                ...
                (pose_est_results, pose_est_results_list, pred_3d_instances,
                 next_id) = self.process_one_image(
                    detector=detector,
                    frame=frame,
                    frame_idx=frame_idx,
...
class Body3dVideoPoseEstimation:
    def __init__(self):
       #path_to_mmpose = "../../mmpose_ap"
        self.det_config = 'D:/Project/Internet/Django/key_video/Key_Video_Mocap/Key_Video_Mocap/ml/mlModel/mmpose_ap/mmpose/.mim/demo/mmdetection_cfg/faster_rcnn_r50_fpn_coco.py'
        self.det_checkpoint = 'https://download.openmmlab.com/mmdetection/v2.0/faster_rcnn/faster_rcnn_r50_fpn_1x_coco/faster_rcnn_r50_fpn_1x_coco_20200130-047c8118.pth'

        self.pose_estimator_config = 'D:/Project/Internet/Django/key_video/Key_Video_Mocap/Key_Video_Mocap/ml/mlModel/mmpose_ap/mmpose/configs/body_2d_keypoint/rtmpose/coco/rtmpose-m_8xb256-420e_aic-coco-384x288.py'

        self.pose_estimator_checkpoint = 'https://download.openmmlab.com/mmpose/v1/projects/rtmposev1/rtmpose-m_simcc-aic-coco_pt-aic-coco_420e-384x288-a62a0b32_20230228.pth'

        self.pose_lifter_config = 'D:/Project/Internet/Django/key_video/Key_Video_Mocap/Key_Video_Mocap/ml/mlModel/mmpose_ap/mmpose/configs/body_3d_keypoint/pose_lift/h36m/pose-lift_motionbert-ft-243frm_8xb32-120e_h36m.py'
        self.pose_lifter_checkpoint = 'https://download.openmmlab.com/mmpose/v1/body_3d_keypoint/pose_lift/h36m/motionbert_ft_h36m-d80af323_20230531.pth'
        self.device = "cuda:0"
        self.num_instances = 1
        self.save_predictions = True
        self.bbox_thr = 0.9
    ...
    def process_one_image(self, detector, frame, frame_idx, pose_estimator,
                          pose_est_results_last, pose_est_results_list, next_id,
                          pose_lifter, visualize_frame, visualizer,  keypoints3Dpos):
        """Visualize detected and predicted keypoints of one image.
